package com.github.learn.immutable;
...
public final class ImmutableHolder {
    ...
    // 构造时，保护性拷贝
    public ImmutableHolder(int i, Integer itg, List<BigDecimal> list, MutableObject mutableObject) {
        this.i = i; // 不可变，可以直接赋值
    ...
    private MutableObject protectCopyObject(MutableObject mutableObject) {
        ...
        Map<String, Integer> mutableField = new HashMap<>(
            mutableObject.getMutableField());
